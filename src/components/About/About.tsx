...
export default function About({ sectionRef }: AboutProps) {
 ...
 return <section className='about' id="about">
  ...
  <div className="about-me">
   ...
   <p>Right now, my go to technologies to work with are React, Next.js, TypeScript, JavaScript, SCSS, and Firebase. I recently grew to love TypeScript and have been coding with that religiously. To test my TypeScript skills in React, I decided to create a reusable component that I published as an NPM which currently has over 700 weekly downloads. </p>
  </div>
  ...
  <div className="experience-container">
   ...
   <div className="experience">
    <h3>808 Partners - Front-End Developer</h3>
    <p>At 808 Partners I worked on a small team creating a social media site for a company called Muunifi. The technology used to develop the site was Next.js, React, TypeScript, MobX, and Firebase. My experience here greatly helped me learn how to write better code and learn how to work well with other developers, project managers, and designers.  </p>
   </div>
   <div className="experience">
    <h3>Dev Mountain - Full Stack Developer</h3>
