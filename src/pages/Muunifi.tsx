   ...
   <SimpleBar className='fretify'>
    ...
    <div className="hero">
     <div className="hero-content">
      ...
      <div className="text">
       <h1>Muunifi</h1>
       <p>Social platform built for financial communities</p>
      </div>

      <div className="image">
       <img src="../images/muunifi-laptop.png" alt="" className='laptop' />
      </div>

      <div className="project-info">
       <div className="info-wrapper">
        <p><span style={{ color: '#7367FE' }}>Role</span>Front-End Developer</p>
        <p><span style={{ color: '#7367FE' }}>Context</span>Professional</p>
        <p><span style={{ color: '#7367FE' }}>Period</span>2023</p>
       </div>
      </div>
    ...
    <div className="project-details">
     <div className="detail-wrapper">
      ...
      <div className="site-images">
       <img src="../images/muunifi.png" alt="" />
      </div>
     </div>
